...
interface DashboardHeaderProps {
  showCreateTRSButton?: boolean; // optional prop to show TRS button
}
  ...
  return (
    <header className="flex justify-between items-center bg-white border-b border-gray-100 px-4 sm:px-6 py-4">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        {showCreateTRSButton &&
          <button className="bg-gradient-to-r from-[#FE4773] to-[#6E114C] text-white text-sm px-4 py-2 rounded-lg"
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-96 p-4 shadow-lg rounded-lg"
          >
            {/* Profile Header */}
